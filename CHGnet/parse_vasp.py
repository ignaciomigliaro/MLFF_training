...
def properties_to_dict(structures,energies_per_atom,forces,stresses):
    dataset_dict = {
    'structure' : structures,
    'energies' : np.array(energies_per_atom),
    'forces' : forces,
...
def prepare_data(output,atoms_list,energies_per_atom,forces,stresses):
